...
export const projects: Project[] = [
  ...
  {
    title: "Github Random - Explorador de Repositorios",
    description: "Aplicación web que permite a los usuarios descubrir repositorios aleatorios en GitHub.",
    technologies: "TypeScript, React, CSS",
    githubUrl: "https://github.com/BriXelDev/Github-random"
  },
  {
    title: 'Weather App - Pronóstico del Tiempo',
    description: 'Aplicación web que proporciona pronósticos del tiempo utilizando la API de OpenWeatherMap.',
    technologies: 'TypeScript, React, CSS',
    githubUrl: 'https://github.com/BriXelDev/Weather'
  }
];
